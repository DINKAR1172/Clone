            ...
            Column(){
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center){
                    Column {
                        ...
                        Text(text = "your preferred", color = colorResource(id = R.color.black), fontStyle = FontStyle.Italic, fontWeight = FontWeight.ExtraBold, fontSize = 40.sp)
                        Text(text = "distance?", color = colorResource(id = R.color.black), fontStyle = FontStyle.Italic, fontWeight = FontWeight.ExtraBold, fontSize = 40.sp)
                    }
                    Image(painter = painterResource(id = R.drawable.distance), contentDescription =null)
                }
                ...
                Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.Center){
                    ...
                    Text(text = "${Distance.toInt()}Km", fontSize = 20.sp,fontWeight = FontWeight.Bold, color = colorResource(
                        id = R.color.Orangess
                    ))
                }
                Spacer(modifier = Modifier.height(3.dp))
                Slider(value =Distance, onValueChange ={Distance=it}, colors = SliderDefaults.colors(
                    colorResource(id = R.color.Orangess)), valueRange = 0f..100f, steps = 100 )
            }
            Column {
               Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center){
                   Text(
